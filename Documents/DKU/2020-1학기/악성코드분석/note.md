...
사이버 킬 체인 (정의): 사이버 공격을 프로세스상으로 분석해, 각 공격 단계에서 조직에 가해지는 위협 요소를 파악하고, 공격자의 목적, 의도, 활동을 분쇄/완화해 보안 조직의 시스템을 확보하는 것.
...
(서버, 우리, 그안ㄴ에 요청하는 서버, ...등)
자세하게 그릴 수록 배경에대한 정보 수집이 완벽하게 될 수 있음
