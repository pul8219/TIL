...
- 인덱스는 쿼리를 빠르게 하는 건 맞으나.. 인서트 같은 업데이트시 느릴 수 있음. 그리고 디스크 공간을 많이 필요로 함.
  ex) 보통 조회하는 경우 테이블은 인덱스 많이 만들어 빠르게 검색할 수 있도로 할 수 있음. 근데 은행 업무같이 업데이트 많이 일어나는 용도에 너무 많은 인덱스 적용하면 도리어 느려질 수 있음
