...
> - 공부 범위: [객체](https://gitlab.com/siots-study/topics/-/wikis/object)의 객체(STEP 11), 프로토타입(STEP 12)
> - 기한: 9/26(토) ~ 9/29(화) (STEP 11), 10/10(토) ~ 10/13(화) (STEP 12)
...
## Prototype은 상속 때문에 중요하다

Prototype Object는 그 생성자 함수로 만들어진 모든 오브젝트에서 공유된다.
...
second.sayInfo(); // second라는 object에 sayInfo 함수가 없기 때문에 Prototype chain을 타고가서(__proto__ 이용) Person Prototype Object에 선언된 sayInfo를 실행한다.
